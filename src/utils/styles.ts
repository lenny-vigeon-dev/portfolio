...
export const h1_sizes = "text-3xl sm:text-4xl md:text-5xl lg:text-6xl fhdp:text-7xl 2kp:text-8xl uhdp:text-9xl text-muted-foreground font-bold";
...
// export const text_sizes = " text-base md:text-lg 5xl:text-xl text-muted-foreground ";
