...
export const h3_sizes_lg = " text-2xl md:text-lg fhdp:text-xl 2kp:text-2xl uhdp:text-3xl 4kp:text-4xl 2uhd:text-5xl font-bold leading-snug " + animated;
...
export const gap2 = " gap-2 2kp:gap-4 uhdp:gap-6 4kp:gap-8 2uhd:gap-10 ";
export const gap4 = " gap-4 uhdp:gap-8 4kp:gap-12 2uhd:gap-16 ";
export const gap10 = " gap-10 uhdp:gap-20 4kp:gap-30 2uhd:gap-40 ";
